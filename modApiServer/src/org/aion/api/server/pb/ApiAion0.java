...
public class ApiAion0 extends ApiAion implements IApiAion {
                    ...
                    for (AionTxReceipt txr : txrs) {
                        ...
                        AionAddress contractAddress =
                                Optional.ofNullable(tx.getDestinationAddress())
                                        .orElse(TransactionUtil.calculateContractAddress(tx));
    ...
    private Message.t_TxDetail getTxDetailsObj(
        ...
        AionAddress contract = TransactionUtil.calculateContractAddress(t);
    ...
    private String generateTransactionSqlStatement(
        ...
        for (Log l : _logs) {
            ...
            log.put(aionAddress.toString()); // address
            log.put(ByteUtil.toHexString(l.copyOfData())); // data
