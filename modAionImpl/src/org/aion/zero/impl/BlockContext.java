...
public class BlockContext {
    public final AionPoSBlock block;
    public final BigInteger baseBlockReward;
    public final BigInteger transactionFee;

    public BlockContext(AionPoSBlock block, BigInteger baseBlockReward, BigInteger transactionFee) {
        this.block = block;
    ...
    public BlockContext(BlockContext context) {
        this.block = new AionPoSBlock(context.block);
