 ...
 */
public class EnergyLimitRule<H extends AbstractBlockHeader> extends DependentBlockHeaderRule<H> {
    ...
    @Override
    public boolean validate(H header, H parent, List<RuleError> errors) {
