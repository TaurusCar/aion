...
/** */
public class AionPoSBlock extends AbstractBlock<StakedBlockHeader, AionTransaction>
        implements PoSBlockInterface {
    ...
    /* Constructors */
    private AionPoSBlock() {}

    // copy constructor
    public AionPoSBlock(AionPoSBlock block) {
    ...
    public AionPoSBlock(byte[] rawData) {
     ...
     */
    public AionPoSBlock(StakedBlockHeader header, List<AionTransaction> transactionsList) {
        this(
    ...
    public boolean isEqual(AionPoSBlock block) {
    ...
    public boolean equals(Object o) {
        ...
        AionPoSBlock block = (AionPoSBlock) o;
    ...
    public static AionPoSBlock createBlockFromNetwork(StakedBlockHeader header, byte[] body) {
        if (header == null || body == null) return null;

        AionPoSBlock block = new AionPoSBlock();
        block.header = header;
        block.parsed = true;
    ...
    public static AionPoSBlock fromRLP(byte[] rlpEncoded, boolean isUnsafe) {
        RLPList params = RLP.decode2(rlpEncoded);
