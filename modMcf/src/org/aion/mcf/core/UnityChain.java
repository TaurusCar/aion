...
import org.aion.mcf.blockchain.PowChain;
...
public interface UnityChain<
                BLKW extends Block,
                BHW extends AbstractBlockHeader,
                BLKS extends Block,
                BHS extends AbstractBlockHeader,
                TX extends Transaction,
                TR extends AbstractTxReceipt,
                INFO extends AbstractTxInfo>
        extends PowChain<BLKW, BHW>, PosChain<BLKS, BHS> {
    ...
    boolean hasParentOnTheChain(BLKW block);
    ...
    List<BHW> getListOfHeadersStartFrom(long number, int limit);

    // /** Returns the list of headers for the main chain.
    //  *  Returns emptyList() for side chain blocks.
    //  */
    // List<BHW> getListOfHeadersStartFrom(
